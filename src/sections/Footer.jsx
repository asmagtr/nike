  ...
  return (
    <footer className='max-container '>
        ...
        <div className='flex flex-col items-start'>
          ...
          <div className='flex items-center gap-5 mt-8'>
            {socialMedia.map((icon)=>(
              <div className='flex justify-center items-center w-12 h-12 bg-white rounded-full cursor-pointer hover:scale-110 '>
                <img 
                src={icon.src}
                alt={icon.alt}
                width={24}
      ...
      <div className='flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
        <div className='flex flex-1 justify-startitems-start font-montserrat gap-2 cursor-pointer '>
